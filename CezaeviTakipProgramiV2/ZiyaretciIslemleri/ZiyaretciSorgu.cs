    ...
    public partial class ZiyaretciSorgu : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            string command = "select ziyaretciID, kimlik as Kimlik, adi as Adi, soyadi as Soyadi, " +
                        ...
                        $"from ZiyaretciKayit where firmaID = '{AnaBolum.firmaID.Trim()}' and ziyaret_tarih between '{tarihBaslangic.Value.ToString("yyyy/MM/dd HH:mm:ss")}' and '{tarihBitis.Value.ToString("yyyy/MM/dd HH:mm:ss")}' and ";
